    ...
    <div className="fixed bottom-0 left-0 w-full sm:bottom-6 sm:left-1/2 sm:-translate-x-1/2 sm:w-[92%] sm:max-w-md z-[45] animate-fade-in-up">
      ...
      */}
      <div 
        ...
        className="w-full border-t border-white/10 sm:border sm:border-largo-primary/25 sm:rounded-2xl px-5 py-4 sm:p-4 shadow-[0_-8px_30px_rgba(0,0,0,0.6)] sm:shadow-2xl flex items-center justify-between sm:glow-amber"
      >
